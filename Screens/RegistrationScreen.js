...
const RegistrationScreen = ({ navigation }) => {
    ...
    const pickImageAsync = async () => {
        ...
        if (!result.canceled) {
            ...
            alert("Ти не вибрав жодної картинки.");
        }
    };
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={styles.box}>
                        ...
                        <TouchableOpacity
                            style={{
                                ...styles.login, ...Platform.select({ ios: { marginBottom: isShowKeyboard ? 215 : 45, }, android: { marginBottom: isShowKeyboard ? -100 : 45, } })
...
const styles = StyleSheet.create({
    ...
    showButton: {
        ...Platform.select({ ios: { top: 16 }, android: { top: 22 } }),
        position: "absolute",
        right: 16,
    },
    showText: {
